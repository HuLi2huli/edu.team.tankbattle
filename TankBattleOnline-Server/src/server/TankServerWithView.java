 ...
 * 服务器端
 */
public class TankServerWithView extends Frame {
	...
	public static void main(String[] args) {
		TankServerWithView ts = new TankServerWithView();
		ts.launchFrame();
		ts.start();
	}
	...
	public void start() {
		...
		while (true) {
			...
			try {
				...
				dos.writeInt(pid);
				dos.writeInt(TankServerWithView.UDP_PORT);// 告诉客户端自己的UDP端口号
				dos.writeInt(TankServerWithView.TANK_DEAD_UDP_PORT);
